...
const CATEGORIES: Category[] = [
  {
    ...
    count: 7,
    icon: ClipboardList,
    tags: ['FAL 1', 'FAL 2', 'FAL 5'],
    href: '/dokumen/new/FAL_BUNDLE',
    bar: 'bg-accent-blue',
  ...
  },
  {
    ...
    count: 5,
    icon: Receipt,
    tags: ['SIB', 'Agency Appt.'],
    href: '/dokumen/new/SIB',
    bar: 'bg-accent-amber',
  ...
  },
  {
    ...
    count: 4,
    icon: Users,
    tags: ['Crew Change', 'Sign-On'],
    href: '/dokumen/new/CREW_CHANGE_NOTICE',
