...
export function SofForm() {
  const { tenant: _t, events: _e, ...sampleHead } = SAMPLE_SOF
  const [head, setHead] = useState<Head>(sampleHead)
  const [events, setEvents] = useState<SofEvent[]>(clone(SAMPLE_SOF.events))
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 items-start">
        <div className="space-y-5">
          <div>
            ...
            <h1 className="font-display text-2xl text-white">Buat Statement of Facts</h1>
            <p className="text-text-secondary text-sm mt-1">Catatan kronologis kejadian selama port call (timeline).</p>
          </div>
          ...
          <section className="bg-card-bg border border-card-border rounded-lg p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <Field label="Operasi" value={head.operation} onChange={set('operation')} />
              ...
              <Field label="Penandatangan agen" value={head.signRole} onChange={set('signRole')} />
            </div>
          </section>

          <section className="bg-card-bg border border-card-border rounded-lg p-5">
            <div className="flex items-center justify-between mb-3">
              <h2 className="font-display text-base text-white">Timeline Event</h2>
