...
const STR: Record<Lang, Strings> = {
  id: {
    ...
    error: 'Galat',
    types: { TASK_DUE: 'Mendekati', TASK_OVERDUE: 'Terlambat', SLA_BREACH: 'Pelanggaran SLA' },
  },
  en: {
    ...
    error: 'Error',
    types: { TASK_DUE: 'Approaching', TASK_OVERDUE: 'Overdue', SLA_BREACH: 'SLA breach' },
  },
}

const JENIS_URUT: JenisPengingat[] = ['SLA_BREACH', 'TASK_OVERDUE', 'TASK_DUE']
