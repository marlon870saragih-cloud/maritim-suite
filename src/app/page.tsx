...
const STR: Record<Lang, {
  ...
  id: {
    ...
    ctaPrimary: 'Mulai uji coba 7 hari', ctaMasuk: 'Masuk',
    ...
    perMonth: '/bulan', priceTag: 'Paling hemat', planCta: 'Coba gratis 7 hari',
    priceNote: 'Port Call Manager termasuk di semua paket. Modul pilihan: Finance Generator · Maritime Dokumen · DA & Invoice Tracker. Bisa upgrade kapan saja.',
    annualNote: 'Berlangganan setahun — gratis 2 bulan.',
    customPrice: 'Custom', customCta: 'Hubungi via WhatsApp',
    plans: [
      { name: '2 Modul', modules: 'Port Call Manager + 1 modul pilihan', price: '250.000', featured: false,
        features: ['Port Call Manager (wajib)', '1 modul pilihan: Finance / Dokumen / Tracker', '2 akun email (pengguna)', 'PDF ber-branding perusahaan'] },
      { name: '3 Modul', modules: 'Port Call Manager + 2 modul pilihan', price: '450.000', featured: false,
        features: ['Port Call Manager (wajib)', '2 modul pilihan dari 3', '5 akun email (pengguna)', 'Semua fitur paket 2 Modul'] },
      { name: 'Semua Modul', modules: 'Keempat modul aktif', price: '600.000', featured: true,
  ...
  en: {
    ...
    ctaPrimary: 'Start 7-day trial', ctaMasuk: 'Sign in',
    ...
    perMonth: '/month', priceTag: 'Best value', planCta: 'Start 7-day trial',
    priceNote: 'Port Call Manager is included in every plan. Optional modules: Finance Generator · Maritime Documents · DA & Invoice Tracker. Upgrade anytime.',
    annualNote: 'Subscribe yearly — get 2 months free.',
    customPrice: 'Custom', customCta: 'Contact via WhatsApp',
    plans: [
      { name: '2 modules', modules: 'Port Call Manager + 1 module of your choice', price: '250.000', featured: false,
        features: ['Port Call Manager (required)', '1 optional module: Finance / Documents / Tracker', '2 email accounts (users)', 'PDFs branded to your company'] },
      { name: '3 modules', modules: 'Port Call Manager + 2 modules of your choice', price: '450.000', featured: false,
        features: ['Port Call Manager (required)', '2 optional modules of 3', '5 email accounts (users)', 'Everything in the 2-module plan'] },
      { name: 'All modules', modules: 'All four modules active', price: '600.000', featured: true,
