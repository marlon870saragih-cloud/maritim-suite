...
async function modeOn(expectedModel) {
  ...
  cek('model call: identitas prompt & skema', mc[0]?.promptId === 'vessel-call-extract' && mc[0]?.promptVersion === '3' && /^[0-9a-f]{64}$/.test(mc[0]?.promptHash ?? '') && mc[0]?.schemaId === 'isi_intake_kunjungan')
