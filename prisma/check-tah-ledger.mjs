...
bagian('1. KUNCI SUMBER — yang tak boleh berubah di Step 3B')
{
  ...
  const SIDIK = {
    ...
    ruteDanUiIntake: '5ab1278dc72283cb3ac36dabbbd4a1c74d1574371e37d565e31029659aa2e316',
  }
...
const MC = muat('src/lib/ai/model-capabilities.ts')
{
  ...
  cek('identitas prompt: id/versi/hash & skema', tercatat.every((m) => m.promptId === 'vessel-call-extract' && m.promptVersion === '1' && /^[0-9a-f]{64}$/.test(m.promptHash) && m.schemaId === 'isi_intake_kunjungan' && m.schemaVersion === '1' && m.provider === 'OPENROUTER'))
